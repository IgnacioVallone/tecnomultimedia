...
PImage spiderman, Obstaculos, FondoInicio, FondoEnJuego, FondoInstrucciones, Perdiste, Ganaste;
PFont FuenteNueva;
...
void draw() {
  ...
  if ( estado.equals("inicio") ) {
    ...
    { 
       ...
       estado = "Perdiste";    // Al chocar contra algo basicamente perdes
      }
    ...
    image(spiderman, width/2, y, 50, 50);  
